...
WEB_PREVIEW_PROFILES = {
    ...
    "640x480": {"interval_ms": 75, "jpeg_quality": 86},
...
BUILD_ID = "2026-06-25-vision-lock-stabilize-01"
...
HYBRID_DETECT_EVERY_N_FRAMES = 12
...
TRACK_SEMANTIC_VERIFY_EVERY_N_FRAMES = 2
TRACK_SEMANTIC_VERIFY_MISSES = 12
TRACK_SEMANTIC_VALID_MS = 6000
...
TRACK_BBOX_SMOOTH_ALPHA = 0.88
TRACK_MAX_CENTER_JUMP_RATIO = 0.55
TRACK_MAX_SCALE_CHANGE = 0.26
TRACK_DX_DEADBAND = 2
TRACK_DY_DEADBAND = 2
TRACK_VELOCITY_ALPHA = 0.82
TRACK_PREDICTION_FRAMES = 3.0
TRACK_MAX_PREDICTION_BOX_RATIO = 0.62
